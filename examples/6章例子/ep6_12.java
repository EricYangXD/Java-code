...
public class ep6_12 implements MouseMotionListener, MouseListener,
		WindowListener { // 实现了三个接口
	private Frame f;
	private TextField tf;

	public static void main(String args[]) {
		ep6_12 two = new ep6_12();
		two.go();
	}
	...
	public void windowClosing(WindowEvent e) {// 为了使窗口能正常关闭，程序正常退出，需要实现windowClosing方法
		System.exit(1);
	}
